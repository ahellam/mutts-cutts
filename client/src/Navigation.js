...
function Navigation({ setIsAuthenticated, setUser, user }) {
  ...
  return (
    <div className="shadow-md p-1 grid grid-cols-2 grid-rows-2 border-2">
      <h1 className="text-4xl p-1 col-start-1 row-start-1 font-bold underline underline-offset-4">
        Mutts Cutts
      </h1>
      ...
      <div className="row-start-2 self-center p-1">
        <nav>
          <NavLink
            ...
            className={({ isActive }) => [
              isActive
                ? "animate-pulse font-bold hover:text-blue-600"
                : "text-slate-600 hover:text-blue-600 active:font-bold",
            ]}
          >
            Home &nbsp;
          </NavLink>
